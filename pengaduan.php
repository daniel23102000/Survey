...
.submit-button {
  ...
  cursor: pointer;
    ...
    <body>
        ...
        <label id="name-label" for="nrp">Nomor KTP</label>
        <input
          type="text"
          name="nrp"
          id="nrp"
      ...
      <div class="form-group">
        <label id="number-label" for="usia">Usia<span class="clue">(optional)</span></label
        >
        <input
          type="text"
          name="usia"
      ...
      <div class="form-group">
        <p>Profesi?</p>
        <select type="text" id="profesi" name="profesi" class="form-control" required>
      ...
      <div class="form-group">
        ...
        <label>
          <input
            ...
            value="lumayan"
            type="radio"
            class="input-radio"/>Lumayan</label>
